Shader "SevenBattles/UI/ActiveUnit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.color = v.color;
                    ...
                    o.rectMask = half4(
                        ...
                        0.25 / (0.25 * float2((_UIMaskSoftnessX + 1), (_UIMaskSoftnessY + 1)))
                    );
                #endif
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // Apply board tint color (SetHighlightColor drives _Color)
                col.rgb *= _Color.rgb;
                col.a *= _Color.a;
                    ...
                    float mask = tex2D(
                        _MaskTex,
                        i.uv * _MaskTexScaleOffset.xy + _MaskTexScaleOffset.zw +
                    ...
                    float mask2 = tex2D(
                        _MaskTex2,
                        i.uv * _MaskTex2ScaleOffset.xy + _MaskTex2ScaleOffset.zw +
                ...
                #if UNITY_UI_CLIP_RECT
                    half2 m = saturate(
                        (_ClipRect.zw - _ClipRect.xy - abs(i.rectMask.xy)) * i.rectMask.zw
                    );
                    col.rgb *= m.x * m.y;
                #endif
